...
public class Windows_par {
    ...
    final static Color EDGE_LINE_COLOR = new Color(83, 83, 117);
    ...
    public final static Color GRAPH_FIELD_BORDER = new Color(93, 91, 71);
    final static Color RESULT_VERTEX_COLOR = new Color(163, 109, 53);
    public final static Color GRAPH_FIELD_BACKGROUND = new Color(146, 200, 161);
